"""Thin wrapper around pyrealsense2 to provide aligned RGB-D frames + intrinsics."""
...
class RealSenseRGBD:
    def __init__(self, width=640, height=480, fps=30):
        # Configure colour + depth streams and prepare alignment helper.
    ...
    def start(self):
        ...
        # Cache camera intrinsics so other modules can project pixels to 3D.
    ...
    def get_aligned_frames(self):
        ...
        # np.asanyarray is the recommended zero-copy conversion from RealSense SDK.
