...
% moving and a block orientation (roll, pitch, yaw) for picking up the block
%
%can i do something like block position.z + ho where ho is height offset when i am defining it
% =========================================================================
